...
def createInitSet(dataSet):
    ...
    for trans in dataSet:
        retDict[frozenset(trans)] = 1 #count
    return retDict #{set:1}
...
if __name__=='__main__':
    ...
    # s=createInitSet(d)
    # # print(d,s)
    # fptree,headertab=createTree(s)
    # fptree.disp()
    # # print(headertab)
    # # path=findPrefixPath('r',headertab['r'][1])
    # # print(path)
    # freqItems=[]
    # mineTree(fptree,headertab,3,set([]),freqItems)
    # print(freqItems)

    d=[line.split() for line in open('kosarak.dat')]
    s=createInitSet(d)
    # print(d,s)
    fptree,headertab=createTree(s,100000)
    fptree.disp()
    # print(headertab)
    # path=findPrefixPath('r',headertab['r'][1])
    # print(path)
    freqItems=[]
    mineTree(fptree,headertab,100000,set([]),freqItems)
    print(freqItems)